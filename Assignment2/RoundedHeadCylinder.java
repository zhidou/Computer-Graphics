/**
 * RoundedHeadCylinder.java - a solid cylinder with a rounded top
 */
 ...
 * @since Spring 2011
 */
public class RoundedHeadCylinder extends Circular implements Displayable {
  /**
   ...
   */
  public RoundedHeadCylinder(final double radius, final double height,
      final GLUT glut) {
    super(radius, glut);
    this.height = height;
  }
