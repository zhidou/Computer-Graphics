...
public class Quaternion {
  ...
  public Quaternion inverse()
  {
	  ...
	  magnitude=this.s*this.s+this.v[0]*this.v[0]+this.v[1]*this.v[1]+this.v[2]*this.v[2];
	  Q.s=this.s/magnitude;
	  Q.v[0]=-this.v[0]/magnitude;
	  Q.v[1]=-this.v[1]/magnitude;
	  Q.v[2]=-this.v[2]/magnitude;
	  return Q;
  }
